...
public class AboutScreenInfo
{
    ...
    public AboutScreenInfo()
    {
        ...
        var footer =
            ...
            "\n";
        var targetPDFsURL = "<link=https://developer.vuforia.com/library/vuforia-engine/images-and-objects/sample-apps-target-pdfs/>";
        ...
        mDescriptions.Add(
            ...
            "\n• <link=https://developer.vuforia.com/library/vuforia-engine/environments/device-tracking/vuforia-fusion/vuforia-fusion/#devices><color=blue><u>Vuforia Fusion Compatible Devices</u></color></link>" +
            "\n\n" +
