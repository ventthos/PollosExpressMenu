/*===============================================================================
Copyright (c) 2015-2025 PTC Inc. All Rights Reserved.
...
public class CameraSettings : AVuforiaSamplesActionsWrapper
{
    ...
    public override void OnDoubleTap(InputAction.CallbackContext context)
    {
        if (!context.performed || mIsFocusing)
            return;
